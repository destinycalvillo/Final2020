...
The guy bar-plot shows their population and their unique relationship to the covid-19 vaccine by either taking it or taking the placebo. 
...
The gal bar-plot shows their population and their unique relationship to the covid-19 vaccine by either taking it or taking the placebo. 
...
The gay bar-plot shows their population and their unique relationship to the covid-19 vaccine by either taking it or taking the placebo. 
...
The druguser bar-plot shows their population and their unique relationship to the covid-19 vaccine by either taking it or taking the placebo. 
...
effectivenessdruguser = druguserfish$estimate/(druguserfish$estimate +1) 
print(effectivenessdruguser*100)
```

```{r}
low=(druguserfish$conf.int[1]/(druguserfish$conf.int[1] +1))
hi=(druguserfish$conf.int[2]/(druguserfish$conf.int[2] +1))
options(digits=2)
```
